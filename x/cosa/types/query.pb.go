...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_889e448b563916bb, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_889e448b563916bb, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "cosa.cosa.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "cosa.cosa.QueryParamsResponse")
}

func init() { proto.RegisterFile("cosa/cosa/query.proto", fileDescriptor_889e448b563916bb) }

var fileDescriptor_889e448b563916bb = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4d, 0xce, 0x2f, 0x4e,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x64, 0x94, 0xac, 0x68, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosa.cosa.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosa.cosa.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "cosa/cosa/query.proto",
}
